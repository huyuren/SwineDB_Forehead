...
public class FeedController extends CommonController<Feed> {
...
//        return getDataActual_precise(name);
    ...
    @Override
    public ResponseResult updateSingleData(@RequestParam("values")List<String> values, @RequestBody Feed object) {
        return updateSingleDataActual(values, object);
    }

    @PostMapping("/save-single-data")
    @Override
    public ResponseResult saveSingleData(@RequestBody Feed object) {
    ...
    @Override
    public ResponseResult deleteBatchOnMainTable(@RequestBody List<Feed> values) {

...
public class MetabolismController extends CommonController<Metabolism> {
    @Autowired
    public MetabolismController(MetabolismService service){
        super("metabolism_name");
    ...
    @Override
    public ResponseResult updateSingleData(@RequestParam("values")List<String> values, @RequestBody Metabolism object) {
        return updateSingleDataActual(values, object);
    }

    @PostMapping("/save-single-data")
    @Override
    public ResponseResult saveSingleData(@RequestBody Metabolism object) {
    ...
    @Override
    public ResponseResult deleteBatchOnMainTable(@RequestBody List<Metabolism> values) {

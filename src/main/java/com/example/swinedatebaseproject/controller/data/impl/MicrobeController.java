...
@RestController
@RequestMapping(value = "/Microbe")
public class MicrobeController extends CommonController<Microbe> {

    @Autowired
    public MicrobeController(MicrobeService service){
//        super("microbe_Name");
//        super("microbe_id");
        super("microbe_Name");
    ...
    @Override
    public ResponseResult updateSingleData(@RequestParam("values")List<String> values, @RequestBody Microbe object) {
        return updateSingleDataActual(values, object);
    }

    @PostMapping("/save-single-data")
    @Override
    public ResponseResult saveSingleData(@RequestBody Microbe object) {
    ...
    @Override
    public ResponseResult deleteBatchOnMainTable(@RequestBody List<Microbe> values) {
